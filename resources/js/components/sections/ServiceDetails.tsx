...
const ServiceDetails = () => {
  ...
  if (error) {
    return <div style={{ textAlign: "center", padding: "60px", color: "red" }}>
      <h4>{error}</h4>
    </div>;
  }
  ...
  return (
    ...
    <section className="service-details-section section-padding">
      <div className="container">
        ...
        {/* Text 1 */}
        {service.text1 && (
          <p className="mb-3">{service.text1}</p>
        )}

        {/* Text 2 */}
        {service.text2 && (
          <p className="mb-3">{service.text2}</p>
        )}
        ...
        {/* Text 3 */}
        {service.text3 && (
          <p className="mb-3">{service.text3}</p>
        )}
